...
func (d SqliteDriver) InsertIgnore(data *DBObjectAddOn, ignore bool) (query string, vals []interface{}) {
...
func (d SqliteDriver) Update(data *DBObjectAddOn) (query string, vals []interface{}) {
	val := reflect.ValueOf(data.parent).Elem()
...
// Select
func (d SqliteDriver) Select(data *DBObjectAddOn, params Params) (query string) {
